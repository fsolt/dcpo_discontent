...
# subtitle: |
abstract: |
    Public discontent with the political system has become an increasingly salient concern in recent years, with the argument that it undermines democratic stability and effective governance.
    Nevertheless, the understanding of the nature, trends, and drivers of political discontent remains debated, largely reflecting the constraints from available survey data and items in the construction of measurement.
    This article takes advantage of the state-of-the-art latent-variable modeling to aggregate survey responses and a comprehensive collection of survey data to generate dynamic comparative estimates of public political discontent (PPD) for over a hundred countries and regions over the past four decades.
    These PPD scores perform well in internal convergent, external convergent, and construct valitation tests.
    Next, a cross-national and longitudinal analysis of PPD in advanced democracies (i.e., OECD countries) highlights that public political discontent has been on a rising trend, rather than merely “trendless fluctuations” as @norris2011democratic claimed.
    Our results reveal that these increased discontents are largely attributable to worsening economic conditions, including low average income, slow growth, and high unemployment rates.
keywords: 
...
-   Haofeng Ma, ORCID: <https://orcid.org/0000-0003-4379-8449>, Postdoctoral Fellow, Institute of Computational Social Science, Chinese University of Hong Kong, Shenzhen, [haofeng-ma\@uiowa.edu](mailto:haofeng-ma@uiowa.edu){.email}
...
Public discontent with political systems and institutions has become an increasingly salient concern in recent years.
Scholars and policymakers have debated whether bolstering public support for democracy can stem the tide of democratic backsliding, yet its effectiveness remains contested [@hu2024democracy; @Claassen2020].
Widespread political discontent—which undermines public confidence in the political process, erodes the legitimacy of governing institutions, and fuels the rise of populism that threatens liberal democracy [@mudde2004populist; @miller1974political; @lipset1959some; @doyle2011legitimacy; @mudderovira2017populism; @urbinati2019political]—may provide a more direct lens for understanding and predicting the erosion of democracy.
...
As a result, we generated estimates of the public’s political discontent in all 3,362 country-years spanned by the source data, which we call Public Political Discontent (PPD) scores.
The PPD scores perform well in all validation tests, proving that they are suitable to be used in analysis.
Our findings clearly suggest that political discontent has been on an increasing trend over time in developed OECD countries, supporting Foa and Mounk's (2016, 2017) thesis of democratic deconsolidation in developed democracies.
We also find that election years are associated with lower levels of discontent, suggesting that elections may provide an outlet for expressing dissatisfaction and seeking redress. 
...
Increases in income inequality over time reduce discontent, in accordance with the predictions of system justification and relative power theories. 
Power-sharing institutions, such as federalism or parliamentarism, appear to have little impact on discontent, although countries with higher disproportionality do exhibit somewhat more discontent. 
This suggests the greater importance of economic conditions in affecting discontent compared to institutional factors.

By providing a broader examination of political discontent and its determinants, this study contributes to ongoing debates about the trajectories of political discontent across countries/regions and over time.
...
@lipset1959some argues that public belief in the system's legitimacy is essential for democratic survival, while @miller1974political notes that discontent can fuel revolutionary changes.
Widespread discontent also complicates governance [@hetherington1998political].
These concerns have driven extensive research on its sources and implications. However, scholars conceptualize political discontent differently, from a lack of diffuse support to low responsiveness, democratic deficit, and political trust issues [@easton1975re; @muller1983discontent; @norris2011democratic; @jennings2016dimensions]. These variations reflect different theoretical motivations and available survey measures.

This paper defines political discontent as dissatisfaction with, or lack of, diffuse support for the system [@Jennings2017], drawing on Easton's [-@Easton1965] distinction between diffuse and specific support.
While specific support pertains to incumbent performance, diffuse support reflects broader system legitimacy.
Prior research highlights that low trust in incumbent government does not always translate into rejection of the system [@citrin1974comment; @miller1974political]. 
...
Diffuse political discontent includes external efficacy, trust in political authorities, and corruption perceptions [@craig1981political; @muller1983discontent; @park2011political]. 
...
Populism studies also link political discontent to anti-system sentiments [@mudde2004populist]. 
While external efficacy assesses system responsiveness, political trust concerns whether authorities act in the public interest [@craig1979efficacy]. 
Implications of political trust can vary depending on the specific referents of trust [@van2017political].
Trust in political institutions differs from trust in government, which fluctuates and does not threaten systemic stability.
Similarly, dissatisfaction with political parties or national officeholders in general is included in political discontent.
...
Corruption resentment shapes electoral behavior and strengthens populist movements [@Daniele2023]. 
In authoritarian regimes, corruption has catalyzed regime collapse [@Carothers2023]. 
Given its universal significance, corruption serves as an essential indicator of political discontent.

Notably, this paper excludes trust in government, as it represents specific support and fluctuates with political cycles [@norris1999critical]. 
Similarly, support for democracy in the abstract is too widespread to serve as a useful discontent measure [@dalton2007understanding; @inglehart2003solid]. 
Satisfaction with democracy also aligns more with government performance than systemic legitimacy [@van2020long; @singh2023satisfaction]. 
For example, economic conditions heavily influence this measure, further limiting its utility [@quaranta2016does].

Conceptualizing political discontent as a lack of diffuse support has critical implications. 
It aligns with concerns about declining systemic confidence beyond dissatisfaction with incumbents. 
This distinction is key for understanding democratic backsliding, where prior research often misuses abstract democratic support as a measure [@Tai2024]. 
Political discontent, in contrast, better captures public sentiment toward systemic stability [@claassen2020does]. 
Studies also link diffuse discontent to regime-challenging activities, underscoring its threat to democratic order [@craig1980mobilization]. 
A clearer understanding of its sources and consequences can inform strategies to enhance democratic resilience. 
...
This parameter varies across different survey questions to reflect that a respondent may need to feel greater discontent to endorse a specific response option for one question compared to endorsing the same level of response for another question.
...
Therefore, the lower a question’s dispersion, the better that changes in responses to the question map onto changes in public political discontent.
...
To this end, we conduct a series of tests to validate our PPD scores.
These include assessments of internal *convergent validity* (i.e., whether the country-year PPD scores align with the individual-level survey items used to generate them), *external convergent validity* (i.e., whether the PPD scores correlate with individual-level survey items that serve as alternative indicators of political discontent, but were not used in constructing our measure), and *construct validity* (i.e., whether the PPD scores are associated with other concepts believed to be causally related to the construct the measure aims to represent).
The methods and results of these tests are presented in full in online Appendix\nobreakspace{}@sec-app-validation.
The PPD scores perform robustly across all validation tests, providing evidence that they are appropriate estimates of the political discontent concept we theorize.
...
if (!file.exists(here("data-raw",
    ...
    download.file("https://dataverse.harvard.edu/api/access/datafile/7878619", "data-raw/swiid9_8.zip")
...
Research on public political discontent has produced inconsistent findings regarding its trends, causes, and consequences, largely due to measurement constraints from available survey data.
Using a state-of-the-art latent-variable model [@Solt2020c], we construct a dynamic comparative measure that challenges @norris2011democratic's claim of "trendless fluctuations."
Our analysis reveals a rising trend of political discontent in OECD countries, driven primarily by worsening economic conditions, including low income, slow growth, and high unemployment. 
Unlike single-country studies [@Jennings2017], our measure integrates cross-national and longitudinal data, offering firmer evidence for ongoing debates on political discontent.
Beyond empirical contributions, this study advances the conceptualization of political discontent. 
While widely studied, it often overlaps with related concepts like political trust and satisfaction with democracy, leading to conflicting findings. 
We define political discontent as the lack of Easton’s [-@Easton1965] diffuse support, clarifying its components and scope. This conceptual clarity provides a stronger foundation for future research.

The Public Political Discontent (PPD) dataset, available on Harvard Dataverse, has broad implications.
Amid rising democratic backsliding, political discontent offers a better lens than abstract democratic support for understanding public dissatisfaction [@hu2024democracy; @Claassen2020]. 
