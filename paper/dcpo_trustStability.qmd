...
The resulting dataset comprises the thirty-eight OECD countries and a total of `r m1_obs` country-years.
...
```{r resplot, fig.cap="Predicting Public Political Discontent in OECD Countries \\label{model}", fig.height = 5, fig.width = 7.5}
...
The results of this analysis are displayed in Figure\nobreakspace{}\@ref(fig:resplot).^[
