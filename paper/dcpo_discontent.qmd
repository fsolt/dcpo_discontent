...
abstract: |
    ...
    These PPD scores are validated with responses to the individual source-data survey items that were used to generate them as well as the democratic evaluation survey item that was not used in our estimation.
...
In this article, we explicitly theorize political discontent as the lack of Easton’s [@Easton1965] diffuse support and spell out what is and is not considered components of the concept.
