...
While scholars and policymakers have traditionally focused on public support for democracy as a key factor of democratic backsliding, its influence remains contested [@hu2024democracy; @Claassen2020].
Mounting evidence suggests that public political discontent can serve as a more revealing indicator for understanding and predicting the erosion of democracy. 
Political discontent manifests as eroding confidence in political processes and diminishing legitimacy of governing institutions [@miller1974political; @lipset1959some]. 
It constitutes an independent dimension of public opinion that increases support for populism, which threatens liberal democracy [@mudde2004populist; @urbinati2019political; @santucci2022structure; @rooduijn2016expressing].
...
The DCPO model is a population-level two-parameter ordinal logistic item response theory model with country-specific item-bias terms; it has previously been used to generate comparable estimates across countries and time of such attitudes as gender egalitarianism [@Woo2023] and political interest [@Hu2024].^[
...
Public political discontent can offers a better analytical lens to democratic backsliding as rising political discontent fosters public support for  populism—frequently a threat to liberal democracy [@mudde2004populist; @urbinati2019political]—and undermines effective governance and political legitimacy [@hetherington1998political; @miller1974political; @lipset1959some].
The relationship between political discontent and populism is particularly concerning because it can create a self-reinforcing cycle: higher political discontent increases public support for populism, and support for populism further reinforces discontent as people become more exposed to its anti-establishment messages. This cycle ultimately leads to greater public support for anti-establishment movements [@rooduijn2016expressing].
With the PPD dataset, researchers can explore how political discontent shapes public political engagement, voting for populism, and influences democratic consolidation and backsliding. 
