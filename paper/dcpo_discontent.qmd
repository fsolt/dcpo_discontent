...
differences result in the same question being interpreted differently in different countries and regions, the
...
Unlike prior research that relies on single-country [@Jennings2017] evidence, our findings are built upon a measure that draws on the most available information across countries/regions and over time.
