...
A comprehensive description of the DCPO model is presented in @Solt2020 and Appendix\nobreakspace{}@sec-app-dcpo.]
...
Following @Jennings2017, we excluded these questions from the latent-variable estimation, not least to avoid assuming that respondents necessarily identify the current political system of their country with democracy.
...
Together, these results provide further evidence of the construct validity of the PPD measure.

Taken together, the validation tests presented in this section, as shown in @fig-int-convergent, @fig-ext-convergent, and @fig-construct, demonstrate that the PPD scores perform very robustly across all validation tests, providing evidence that they are appropriate estimates of the political discontent concept we theorize and thus suitable to be used in analysis.
...
The time-series cross-national Public Political Discontent (PPD) dataset presented in this article, which is publicly available on the Harvard Dataverse, has broad implications for future research. 
...
Yet empirical findings remain mixed, in part because measures of democratic support tend to be uniformly high and therefore lack the discriminatory power needed to capture meaningful variation in citizens’ democratic commitment [@dalton2007understanding; @inglehart2003solid]. 
Public political discontent offers more informative analytical lens for studying democratic backsliding given its close association with regime-challenging attitudes and behaviors [@craig1980mobilization].
...
Finally, because the dataset covers most countries and regions worldwide, including non-democracies, it enables systematic analysis of how the causes and consequences of political discontent vary across regime types, underscoring the importance of public opinion for regime stability.
