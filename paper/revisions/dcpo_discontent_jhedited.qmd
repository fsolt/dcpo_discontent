...
In the following section, we first discuss various scholarly debates over the concept of political discontent, providing our conceptualization of political discontent. Then, we explain the method 
...
Our conceptualization of political discontent also encompasses several components related to diffuse support in distinct ways: external efficacy (evaluation of the responsiveness of political authorities in general), evaluation of the trustworthiness and integrity of political authorities, and perceptions of political corruption [@craig1981political; @muller1983discontent; @park2011political]. 
...
For example, while recent studies provide mixed evidence on the role of public opinion in democratic erosion [@claassen2020does], many rely on measures of abstract support for democracy that tend to be uniformly high and therefore lack the discriminatory power needed to capture meaningful variation in citizens’ democratic commitment [@dalton2007understanding; @inglehart2003solid]. 
In contrast, political discontent offers a more direct signal of potential threats to democratic stability, given its close association with regime-challenging attitudes and behaviors [@craig1980mobilization].
Lastly, this conceptualization enables researchers to integrate diverse existing approaches to political discontent, which rely on different measures and often yield conflicting results, within a shared and comprehensive framework.
...
After estimating public political discontent over `r n_countries` countries over the `r n_years` years, we now focus on a group of countries where discontent has attracted particular public and scholarly concern, the advanced democracies of the OECD, in order to illustrate the utility of the Public Political Discontent scores.
...
Existing scholarship offers a range of perspectives on whether public political discontent has increased over time and how political and economic contexts shape it, yet empirical findings remain mixed, largely because studies rely on different conceptualizations and survey measures.
In the following section, we briefly review these theoretical explanations and evaluate their implications using the PPD scores, which provide a comprehensive and unified test of competing explanations.
...
To address these limitations, this article first offers a clearer conceptualization of political discontent as the lack of Easton’s [-@Easton1965] diffuse support, explicitly defining what is—and is not—considered part of the concept.
...
Moreover, using a state-of-the-art latent-variable model, we construct a novel dynamic comparative measure of public political discontent across 136 countries and over 56 years.
With this new dataset, we clearly show a clear rising trend of political discontent across OECD countries, challenging @norris2011democratic's claim that the changes in political discontent are merely "trendless fluctuations." 
Our analysis also reveals the rise of political discontent in the public is driven by worsening economic conditions, including low income, slow growth, and high unemployment. 
