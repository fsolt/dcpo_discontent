...
We are grateful to the reviewers for their thoughtful reviews and their suggestions on how to improve the paper. We believe that the questions and the resulting changes to the manuscript have greatly improved the accessibility of the manuscript to future readers. In the following, we will respond to the individual queries.

First, R1 worried that the DCPO model resembles a "magic trick" that stitches together fundamentally incomparable surveys, smooths them, and draws overly strong conclusions.
...
And second, we provide a fuller discussion of the model both in the text (at pages 9-10) and in a specific section in the supplementary material (Appendix A2).
