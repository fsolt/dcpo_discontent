...
1. R1 worried that the DCPO model resembles a "magic trick" that stitches together fundamentally incomparable surveys, smooths them, and draws overly strong conclusions.
...
2. On the topic of the country-specific item bias parameters, $\delta_{kq}$, R1 raises the concern that "in practice, such a parameter can end up absorbing almost everything."
...
These terms do not, however, absorb "genuine cross-national variation in discontent," the problematic possibility that prompts R1's concern.
